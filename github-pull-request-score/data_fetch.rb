...
#      raise if f[:created_at].localtime < Time.new(2014, 1, 1)
#
...
#end
#
#ENV['REPO'] = 'muumuu-domain/www-muumuu-domain'
#begin
#  page = 1
#  while
#    fetched_pulls = client.pull_requests(ENV['REPO'], state: :closed, page: page)
...
#end
#
#ENV['REPO'] = 'muumuu-domain/domainapi-muumuu-domain'
#begin
#  page = 1
#  while
#    fetched_pulls = client.pull_requests(ENV['REPO'], state: :closed, page: page)
